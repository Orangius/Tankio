...
Usage: 
I.	visit *website* and Sign Up 
II.	Navigate to the dashboard
III.	Enter the ID of the tank monitor hardware associated with the tank you want to control
IV.	The tank is all yours to control and monitor from anywhere in the world
